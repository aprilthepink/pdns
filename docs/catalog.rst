...
Secondary zone support requires :ref:`setting-secondary-catalog-members` to be enabled.
...
This requires the :ref:`setting-secondary-catalog-members` setting to be enabled:
